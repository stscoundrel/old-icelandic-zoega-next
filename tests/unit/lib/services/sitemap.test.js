...
describe('Sitemap tests', () => {
  process.env.NEXT_PUBLIC_SITE_URL = 'https://old-icelandic.vercel.app'
  ...
  test('Sitemap content can be formatted to XML.', async () => {
    ...
    expect(result.includes('<url><loc>https://old-icelandic.vercel.app/word/skilja</loc><changefreq>monthly</changefreq><priority>0.5</priority></url>')).toBeTruthy()
  })
